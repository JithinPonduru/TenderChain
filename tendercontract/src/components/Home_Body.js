                ...
                <div className="row justify-content-center">
                  <div className="col-lg-6 text-center">
                    ...
                    <motion.p
                      ...
                      data-aos-once='true'
                    >
                      Experience efficiency and security like never before with our blockchain-powered platform. Explore tamper-proof contract storage, automated execution, and decentralized access control for streamlined contract management. Join us as we revolutionize the way contracts are handled. Welcome!
                    </motion.p>
                ...
                <div className="row justify-content-between gy-4">
                  ...
                  <div className="col-lg-6 d-flex align-items-center" >
                    <motion.div
                      ...
                      data-aos-once='true'
                    >
                      <h3 style={{ color: '#52565e', marginBottom: '5%' }}>Blockchain-Powered Contract Management: Enhanced Efficiency and Security.</h3>
                      <p>
                        Blockchain-powered contract management systems provide a flexible method of transaction with immutable contracts that ensure data is protected from tampering. With smart contracts, contracts can be executed once preconditions are met, thus simplifying the contract lifecycle and reducing the impact of guidance. Decentralized access control mechanisms increase security and privacy, while timestamping and auditing capabilities provide an audit trail for compliance and resolution. Seamless integration with external systems, automated compliance and multi-party collaboration ensure efficiency and transparency. Additionally, tokenizing assets on the blockchain increases ownership and facilitates asset transfers. Overall, these features work together to reduce costs, increase security, and increase the efficiency of contract management.
                      </p>
                    </motion.div>
                  </div>
                  <motion.div layoutId="underline" className="col-lg-5 form" >
                    <div className="form-content">
                      <h2 style={{ color: "#ffbb00", marginBottom: "8%" }}>
                        ...
                        <span id="login-heading" onClick={() => showForm('login-form')}>Log In</span>
                      </h2>
              ...
              <div className="container" >
                ...
                <div className="row justify-content-around gy-4">
                  <div data-aos='fade-up' data-aos-once='true'
                    data-aos-duration="1500" className="col-lg-6 img-bg" style={{ backgroundImage: "url(assets/img/alt-services.jpg)" }}></div>

                  <div className="col-lg-5 d-flex flex-column justify-content-center">
                    <h3>Key Features Overview</h3>
                    <p>Explore the core functionalities driving our contract management system.</p>

                    <motion.div className="icon-box d-flex position-relative"
                      data-aos='fade-up'
                      data-aos-once='true'
                    >
              ...
              <div className="container">
                ...
                <div className="tab-content">
                    ...
                    <div className="row">
                      <div className="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                        ...
                        <p className="fst-italic">
                          Immutable contract storage refers to the practice of storing contracts on a blockchain network, where they are recorded in a tamper-proof and transparent manner.
                        </p>
                        <ul>
                          <li><i className="bi bi-check2-all"></i> Contracts stored on the blockchain are immutable, ensuring that they remain unchanged and secure over time.</li>
                          <li><i className="bi bi-check2-all"></i> All contract-related activities are recorded on the blockchain, providing a transparent and auditable record of events.</li>
                          <li><i className="bi bi-check2-all"></i> Immutable contract storage minimizes the risk of fraud, manipulation, or unauthorized alterations, promoting trust and reliability in contractual agreements.</li>
                        </ul>
                      </div>
                  ...
                  <div className="tab-pane" id="tab-2">
                    <div className="row">
                      <div className="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                        ...
                        <p className="fst-italic">
                          Smart contract execution revolutionizes traditional contract processes by leveraging blockchain technology to automate contract execution. These self-executing contracts contain predefined rules and conditions encoded into smart contract code.
                        </p>
                        <ul>
                          <li><i className="bi bi-check2-all"></i> Smart contracts execute predefined actions automatically, based on predetermined conditions, without human intervention.</li>
                          <li><i className="bi bi-check2-all"></i> By removing intermediaries, smart contracts reduce costs and streamline processes, leading to faster and more secure transactions.</li>
                          <li><i className="bi bi-check2-all"></i> The automation of contract execution reduces the risk of human error and minimizes the potential for disputes, enhancing trust and reliability in contractual agreements.</li>
                        </ul>
                      </div>
                      <div className="col-lg-6 order-1 order-lg-2 text-center">
                  ...
                  <div className="tab-pane" id="tab-3">
                    <div className="row">
                      <div className="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                        <h3>Enhanced Collaboration for Effective Contract Management</h3>
                        <p>Multi-party collaboration is facilitated through a shared space within the platform, allowing all involved parties to collaborate in real-time. This feature promotes transparency, communication, and decision-making, thereby enhancing the efficiency of contract negotiations and execution.</p>
                        <ul>
                          <li><i className="bi bi-check2-all"></i> The platform enables real-time communication and collaboration among all parties involved in the contract, facilitating swift decision-making.</li>
                          <li><i className="bi bi-check2-all"></i> Users can track changes made to the contract document, ensuring transparency and accountability throughout the negotiation process.</li>
                          <li><i className="bi bi-check2-all"></i> Through collaborative discussions and feedback, parties can work towards consensus on contract terms and conditions, fostering trust and agreement.</li>
                        </ul>
                      </div>
                      <div className="col-lg-6 order-1 order-lg-2 text-center">
